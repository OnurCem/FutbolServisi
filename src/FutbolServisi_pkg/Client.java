...
public class Client {
	...
	public static void takimEkle() throws ServiceException, MalformedURLException, RemoteException {
		String endpoint = "http://localhost:8080/FutbolServisi/services/FutbolServisiSOAP";
		
		Service service = new Service();
		Call call = (Call) service.createCall();
		
		//Servis geri donus tipini XML olarak belirliyor ve bu sinif icin serializer/deserializer yaratiyor
